describe("Calculator", function() {
	...
	describe("Add method", function() {
		...
		it("should not return 4 if the sum of the arguments given don't equal 4", function() {
			calc.add(7);
			calc.add(19);
			expect(calc.value).toBe(26);
		});

		it("should have called the alert function if either argument is undefined", function(){
			spyOn(window, "alert");
			calc.add("Hello");
